...
`docs/internals/memory-across-campaigns.md` documents the
...
`/loop`), see `docs/internals/campaign.md` and `slash_commands/commands/campaign-hpc.md`.
...
end-to-end Optuna recipe in `docs/internals/campaign.md`. None bind the framework
...
- **`/campaign`** — slash command with the conversational interview;
  ...
  `docs/internals/campaign.md` (random search, Optuna ask/tell, walk-forward).
