...
Implementation lives in `hpc_agent/models/mapreduce/reduce/`, `hpc_agent/runner/`, and `hpc_agent/ops/aggregate/combine.py` respectively. Treat the source as the contract; these scripts are not version-pinned across releases.
