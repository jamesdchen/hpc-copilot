...
| [cluster-readiness](cluster-readiness.md) | yes | _none_ | `hpc-agent cluster-readiness --spec <path> [--experiment-dir <dir>]` |
...
| [validate-scaffold-staleness](validate-scaffold-staleness.md) | yes | _none_ | `(none — Python-only primitive)` |
...
| [export-bundle](export-bundle.md) | yes | file_write: `<output_path>` | `hpc-agent export-bundle --spec <path> [--experiment-dir <dir>]` |
...
| [pack-refresh](pack-refresh.md) | no | file_write: `<experiment>/<pack>/manifest.json`; file_write: `<experiment>/.hpc/packs/<pack>.decisions.jsonl` | `hpc-agent pack-refresh --spec <path> [--experiment-dir <dir>]` |
| [program-init](program-init.md) | no | file_write: `<experiment>/packs/<program>/**`; file_write: `<experiment>/.hpc/packs/<pack>.decisions.jsonl` | `hpc-agent program-init --spec <path> [--experiment-dir <dir>]` |
...
| [queue-dispatch](queue-dispatch.md) | yes | file_write: `<experiment>/.hpc/queue/intake.jsonl`; scheduler-submit: `<cluster>`; writes-journal: `prunes` | `hpc-agent queue-dispatch [--spec <path>] [--experiment-dir <dir>]` |
