...
| [`cluster-readiness`](../primitives/cluster-readiness.md) | ✓ | _none_ | `hpc-agent cluster-readiness --spec <path> [--experiment-dir <dir>]` | `_(none)_` | — | — |
...
| [`pack-status`](../primitives/pack-status.md) | ✓ | _none_ | `hpc-agent pack-status --spec <path> [--experiment-dir <dir>]` | `_(none)_` | — | — |
...
| [`notebook-record`](../primitives/notebook-record.md) | ✗ | file_write | `hpc-agent notebook-record --spec <path> [--experiment-dir <dir>]` | `_(none)_` | — | — |
...
| [`campaign-refill`](../primitives/campaign-refill.md) | ✓ | file_write; scheduler-submit; writes-campaign-state | `hpc-agent campaign-refill --spec <path> [--experiment-dir <dir>]` | `_(none)_` | — | — |
