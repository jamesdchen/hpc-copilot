...
| [`submit-flow-batch`](primitives/submit-flow-batch.md) | ✓ | rsync; scheduler-submit; writes-journal | `hpc-mapreduce submit-flow-batch --spec <path>` | `claude_hpc.flows.submit_flow.submit_flow_batch` | — | — |
