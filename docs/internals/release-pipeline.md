...
skill (`.claude/skills/release/SKILL.md` — repo-level maintainer surface,
outside the wheel since the 2026-07-28 dev-loop/product separation) still does all the local,
