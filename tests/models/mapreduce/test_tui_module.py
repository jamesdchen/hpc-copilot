"""Smoke tests for hpc_agent.models.mapreduce.reduce.tui.
...
def test_module_imports_without_rich(monkeypatch):
    ...
    sys.modules.pop("hpc_agent.models.mapreduce.reduce.tui", None)
    mod = importlib.import_module("hpc_agent.models.mapreduce.reduce.tui")
...
def test_run_tui_errors_cleanly_when_rich_missing(monkeypatch, tmp_path, capsys):
    ...
    from hpc_agent.models.mapreduce.reduce import tui
...
def test_render_returns_rich_group_when_rich_present(tmp_path):
    ...
    from hpc_agent.models.mapreduce.reduce.tui import _render, _UiState
