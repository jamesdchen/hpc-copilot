"""Unit tests for :mod:`hpc_agent.infra.cache`.
...
from hpc_agent.infra.cache import TTLCache, clear_all
...
def test_get_returns_none_after_ttl() -> None:
    ...
    base = time.monotonic()
    with mock.patch("hpc_agent.infra.cache.time.monotonic") as mt:
