"""Stable constants for integrators composing on top of claude-hpc.
...
constants so harness code can ``from claude_hpc.integration import …``
...
the package-shipped default at ``claude_hpc/config/clusters.yaml``."""
