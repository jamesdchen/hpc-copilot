...
batching logic that lives in :mod:`claude_hpc.planning.throughput`.
...
* :class:`ResubmitPlan` / :class:`ResubmitBatch` — the resubmission
  analogue of :class:`~claude_hpc.planning.throughput.SubmissionPlan`, whose
...
* :func:`resubmit_plan` — build a :class:`ResubmitPlan` from a known task
  ...
  :func:`~claude_hpc.planning.throughput.compute_submission_plan` to split the
...
from claude_hpc.planning.throughput import WorkloadSpec, compute_submission_plan
...
class ResubmitBatch:
    ...
    Unlike :class:`~claude_hpc.planning.throughput.JobBatch`, the task IDs in
...
def resubmit_plan(
    *,
    ...
    constraints:
        ...
        :class:`~claude_hpc.planning.constraints.ClusterConstraints` (i.e.
    ...
    :func:`~claude_hpc.planning.throughput.compute_submission_plan`: we
    submit a :class:`~claude_hpc.planning.throughput.WorkloadSpec` with
