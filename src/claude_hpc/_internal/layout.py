...
class JournalLayout:
    ...
    def repo_hash(self) -> str:
        ...
        Delegates to :func:`claude_hpc._internal.session.repo_hash` so the
        canonical implementation stays in one place during the B1
        migration.
        """
        from claude_hpc._internal.session import repo_hash as _rh
    ...
    def root(self) -> Path:
        ...
        from claude_hpc._internal.session import journal_dir
