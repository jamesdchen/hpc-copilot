...
The implementation lives in :mod:`hpc_agent.template._runtime`, the
self-contained stdlib-only cluster runtime that
:func:`hpc_agent.template.export_notebook` inlines verbatim into an
exported executor. This module is a pure re-export keeping the
``hpc_agent.template.register`` import path stable.
...
a separate authoring step — see :func:`hpc_agent.template.flags_for_run`.
"""

from __future__ import annotations

from hpc_agent.template._runtime import RunSpec, register_run, save_artifact
