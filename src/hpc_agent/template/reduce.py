"""Monoid-reduce glue for :class:`~hpc_agent.template.Associative` axes.

When a series axis is :class:`~hpc_agent.template.Associative`, each
chunk emits a :class:`~hpc_agent.template.Monoid` partial instead of a
...
from hpc_agent.template.axis import Monoid
