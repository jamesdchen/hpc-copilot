...
:func:`hpc_agent.template.load_series` for its data, and returns either
...
- a :class:`~hpc_agent.template.Monoid` partial — for an
...
from hpc_agent.template.axis import Associative, BoundedHalo, DataAxis, Independent, Sequential
from hpc_agent.template.plan import plan_tasks
from hpc_agent.template.reduce import reduce_monoid
