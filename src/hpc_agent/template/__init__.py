"""``hpc_agent.template`` — bring-a-notebook experiment + parallelization layer.
...
from hpc_agent.template.series import (
    SeriesNotConfigured,
    SliceSpec,
    current_slice,
    load_series,
...
from hpc_agent.template.signature import flags_for_run, flags_from_ast, flags_from_signature
