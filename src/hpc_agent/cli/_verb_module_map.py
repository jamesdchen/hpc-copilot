...
VERB_MODULE_MAP: dict[str, tuple[str, str]] = {
    ...
    'alerts-ack': ('alerts-ack', 'hpc_agent.ops.recover.alerts_ack'),
    ...
    'attach-diagnosis': ('attach-diagnosis', 'hpc_agent.ops.recover.diagnosis'),
    ...
    'diagnosis-request': ('diagnosis-request', 'hpc_agent.ops.recover.diagnosis'),
    'dir-digest': ('dir-digest', 'hpc_agent.ops.dir_digest'),
    'discover': ('discover', 'hpc_agent.state.discover'),
    ...
    'notebook-dry-run': ('notebook-dry-run', 'hpc_agent.ops.notebook.dry_run_op'),
    'notebook-lint': ('notebook-lint', 'hpc_agent.ops.notebook.lint'),
    'notebook-record': ('notebook-record', 'hpc_agent.ops.notebook.record_op'),
    ...
    'scope-lock': ('scope-lock', 'hpc_agent.ops.decision.journal.scope_lock'),
    'scope-status': ('scope-status', 'hpc_agent.ops.decision.journal.scope_lock'),
    'settle-aggregate': ('settle-aggregate', 'hpc_agent.ops.settle_aggregate'),
