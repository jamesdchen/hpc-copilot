...
VERB_MODULE_MAP: dict[str, tuple[str, str]] = {
    ...
    "check-task-generator-mismatch": (
        "check-task-generator-mismatch",
        "hpc_agent.ops.check_task_generator_mismatch",
    ),
    ...
    "classify-campaign-path": (
        "classify-campaign-path",
        "hpc_agent.incorporation.classify_campaign_path",
    ),
