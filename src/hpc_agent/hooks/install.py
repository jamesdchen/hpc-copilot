"""Install / preview hpc-agent Stop hooks in ~/.claude/settings.json.
...
from hpc_agent.hooks import monitor_armed_check
...
def install_hooks(*, settings_path: Path | None = None, dry_run: bool = False) -> dict[str, Any]:
    """Install hpc-agent Stop hooks; return a summary dict.
