...
from hpc_agent._schema_models.validators.validate import ValidateResult, ValidateSpec
...
def validate_submission(experiment_dir: Path, *, spec: ValidateSpec) -> ValidateResult:
    ...
    * ``scheduler_response``: raw probe stdout (clamped) for debugging.
    ...
    # for free.
    from hpc_agent.planning.planner import _eta_via_test_only_with_resources
