...
:func:`hpc_agent.incorporation.template.export_notebook` inlines verbatim into an
exported executor. This module is a pure re-export keeping the
``hpc_agent.incorporation.template.register`` import path stable.
...
a separate authoring step — see :func:`hpc_agent.incorporation.template.flags_for_run`.
"""

from __future__ import annotations

from hpc_agent.incorporation.template._runtime import RunSpec, register_run, save_artifact
