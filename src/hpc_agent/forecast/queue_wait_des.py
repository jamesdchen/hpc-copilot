...
from hpc_agent.forecast.queue_wait_baseline import (
...
def _des_eligible(experiment_dir: Path, *, cluster: str) -> _DESDecision:
    ...
    """
    try:
        from hpc_agent.forecast.queue_simulator import extract_running_jobs
...
def _default_candidate(profile: str) -> Any:
    ...
    """
    from hpc_agent.forecast.queue_simulator import SimJob
