...
2. Predict the residual lifetime via
   :func:`hpc_agent.forecast.residual_lifetime.predict_residual_lifetime`.
...
:mod:`hpc_agent.forecast.queue_wait_baseline`). The output is meant
...
from hpc_agent.forecast.residual_lifetime import predict_residual_lifetime
