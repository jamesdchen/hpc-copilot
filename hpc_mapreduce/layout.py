...
class JournalLayout:
    ...
    def repo_hash(self) -> str:
        ...
        Delegates to :func:`slash_commands.session.repo_hash` so the
        canonical implementation stays in one place during the B1
        migration.
        """
        from slash_commands.session import repo_hash as _rh
    ...
    def root(self) -> Path:
        ...
        from slash_commands.session import journal_dir
