...
from hpc_agent_pro.forecast.best_submit_window import WindowCandidate, best_submit_windows
...
def recommend_resubmit_window(
    ...
    *,
    ...
    within_hours:
        ...
        :func:`~hpc_agent_pro.forecast.best_submit_window.best_submit_windows`.
