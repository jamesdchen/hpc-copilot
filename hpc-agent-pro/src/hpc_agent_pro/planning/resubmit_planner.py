...
* :func:`~hpc_agent_pro.atoms.walltime_arbitrage.arbitrage_walltime`
...
* :func:`~hpc_agent_pro.planning.daisy_chain.should_daisy_chain` — flag
...
:mod:`hpc_agent_pro.forecast.calibration`).
